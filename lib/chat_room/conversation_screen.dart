...
class _ConversationScreenState extends State<ConversationScreen> {
  ...
  void initState() {
    ...
    databaseMethods.getUserbyUsernameSnapshot(widget.userName).then((value) {
      setState(() {
        userStream = value;
      });
    });
...
class MessageTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding:
          EdgeInsets.only(left: isSendByMe ? 0 : 8, right: isSendByMe ? 12 : 0),
